...
# T3C Package-Specific Job Roles and Requirements Reference Guide
...
## Job Roles and Requirements by Package

### 1\. TREATMENT DIRECTOR

#### Mental & Behavioral Health Support Services Requirements:

**Qualifications (Must meet ONE of the following):**

- **Option A:** Psychiatrist or psychologist  
- **Option B:** Master's degree in human services field from accredited college/university AND 3 years experience providing treatment services for children with emotional disorders (including 1 year in residential childcare setting)  
- **Option C:** Licensed master social worker, licensed clinical social worker, licensed professional counselor, or licensed marriage and family therapist AND 3 years experience providing treatment services for children with emotional disorders (including 1 year in residential childcare setting)

#### IDD/Autism Spectrum Disorder Support Services Requirements:
...
| :---- | :---- | :---- |
| ❌ **CANNOT BE CONTRACTED** | Must be actual employee at time of application | Must be employed and active Day 1 of operations |
...
| Contracting Status | Application Requirements | Implementation Timeline |
| :---- | :---- | :---- |
| ✅ **Can be contracted** | Plan required at application showing timeline for hiring/contracting | Must be in place by first placement |
...
| Contracting Status | Application Requirements | Implementation Timeline |
| :---- | :---- | :---- |
| ✅ **Can be contracted** | If using existing staff: Plan with timeline for training and adding T3C responsibilities If hiring/contracting new: Plan including job description development, hiring timeline, onboarding process, and training curriculum | Must have plan at application; staff/contractors must be trained and ready for first placement |

---

### 4\. REGISTERED NURSE (RN)

#### IDD/Autism Package ONLY:
...
- Available 24/7 for consultation (can be on-call)  
- Support for medical protocols and procedures  
- Training caregivers on medical needs  
- Medication oversight and consultation  
- Health plan development and monitoring

**Availability Requirements:**

- Must be available 24 hours a day/7 days a week for new admissions, training, consultation, and oversight

| Contracting Status | Application Requirements | Implementation Timeline |
| :---- | :---- | :---- |
| ✅ **Can be contracted** | Plan showing how 24/7 availability will be maintained | Must have coverage arrangement in place at application |
...
1. **For ALL positions:**  
   ...
   - Detailed plan identifying how each role will be fulfilled  
   - Timeline for implementation  
   - Training plans for each position

   

2. **For Treatment Director:**  
     
   - Documentation of qualified employee OR  
   - Hiring timeline with specific candidate identified

   

3. **For positions that will be contracted:**  
     
   - Draft scope of work/contract terms  
   - Process for contractor selection  
   - Training and oversight plans

### Can Be Developed During Interim Period:

1. **Detailed policies and procedures** for each role  
2. **Complete training curricula** (beyond initial training plan)  
3. **Full staffing** (but must show clear timeline for hiring)  
4. **Formal contracts** (but must have draft agreements)
...
## Contracting Guidelines Summary

### ✅ **CAN Be Contracted:**

- Licensed Therapist  
- Behavioral Support Specialist/Mentor  
- Registered Nurse (IDD/Autism only)  
- Crisis Management Staff  
- Most infrastructure support functions\*

### ❌ **CANNOT Be Contracted (Must be Employees):**
...
\*Note: Contracted personnel must be trained in and practice the agency's Evidence-informed Treatment Model

---

## Important Notes About Educational Requirements

### Positions with NO Specific Degree Requirements:

- **Behavioral Support Specialist/Mentor** \- No degree required, but must have relevant experience and complete agency training  
- **Crisis Management Staff** \- No degree required, but must complete crisis intervention and de-escalation training

### What This Means for Your Application:

1. **Flexibility in Hiring:** You can hire based on experience and skills rather than specific degrees  
2. **Training is Critical:** Must develop comprehensive training plans for these positions since formal education isn't mandated  
3. **Documentation:** Your application should emphasize:  
   - The experience and skills you're looking for  
   - Your comprehensive training program  
   - How you'll ensure competency without degree requirements  
4. **Quality Assurance:** Consider implementing competency assessments or certifications to ensure staff meet performance standards
