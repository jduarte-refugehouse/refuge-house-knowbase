...
The Education Liaison coordinates and supports the educational needs of children, youth, and young adults in foster care, ensuring academic success, post-secondary preparation, and compliance with educational requirements. \[T3C\] This position fulfills the Education Liaison infrastructure requirement for all T3C Service Packages. \[TBRI\] Educational support is delivered through a trauma-informed lens, recognizing that academic success is deeply connected to emotional safety and relational trust.

---

## T3C INFRASTRUCTURE FUNCTION ALIGNMENT

This position fulfills the required T3C Infrastructure Function: **Education Liaison for Children in Care**
...
* Develop and implement educational service plans addressing high school completion and post-secondary opportunities  
* \[T3C\] Ensure educational goals align with Service Package requirements and individualized treatment plans  
* Facilitate school enrollment, transitions, and evaluation coordination  
* \[T3C\] Coordinate specialized educational planning for Mental & Behavioral Health and IDD/Autism service packages  
* \[TBRI\] Apply trauma-informed strategies that support felt safety and academic engagement

**Special Education and Accommodations**

* Coordinate educational assessments and implement recommended accommodations  
* Assist in developing IEPs and Section 504 Plans  
* \[T3C\] Ensure children with IDD/Autism receive appropriate specialized educational services  
* Advocate for appropriate educational services and support  
* Monitor implementation of accommodations and modifications

**Post-Secondary Preparation**

* \[T3C\] Develop transition plans for youth preparing for post-secondary education or training  
* Coordinate college/vocational applications and financial aid processes  
* Connect youth with Education and Training Voucher (ETV) Program resources  
* Support development of education-related independent living skills

### Stakeholder Collaboration

**Educational Advocacy and Meetings**

* Serve as primary contact between agency, schools, caregivers, and educational systems  
* Attend ARD (Admission, Review, and Dismissal) meetings and educational conferences  
* \[TBRI\] Educate school personnel on trauma-informed educational approaches  
* Address educational concerns, disciplinary issues, and barriers to success

**Team Integration**

* Work closely with case managers to integrate educational needs into service planning  
* Coordinate with treatment team to align educational and therapeutic goals  
* \[T3C\] Collaborate with Cross-System Coordination function for comprehensive service delivery  
* Build partnerships with school districts and educational resources  
...
* Maintain accurate educational records and track academic progress  
* Document school evaluations, IEPs, 504 Plans, and educational outcomes  
* Ensure compliance with ESSA, IDEA, and foster care educational requirements  
* Prepare educational reports for service plan reviews  
* \[T3C\] Maintain audit-ready documentation for all service packages

**Continuous Quality Improvement**

* \[T3C\] Participate in CQI committees and contribute educational outcome data  
* Track educational stability metrics (school changes, enrollment gaps, graduation rates)  
* Analyze trends and identify improvement opportunities  
* Implement evidence-based educational support practices

### Infrastructure Development (Implementation Phase)

**System Building**

* Develop educational coordination processes and procedures for all service locations  
* Create tools and systems for tracking educational needs and outcomes  
* Build resource libraries for educational advocacy and support  
* Establish protocols for educational crisis response  
* Develop training materials for caregivers and staff
...
* Minimum 2 years experience in education, special education, or educational advocacy  
* Experience with foster care or child welfare systems (Preferred)  
* \[T3C\] Understanding of trauma-informed educational approaches

### Knowledge, Skills, and Abilities

**Core Competencies**

* Comprehensive knowledge of special education laws (IDEA, Section 504, ESSA)  
* Understanding of IEP development and implementation  
* \[TBRI\] Knowledge of trauma-informed educational practices  
* Familiarity with foster care regulations and educational rights  
* Post-secondary transition planning expertise

**Essential Skills**

* Strong organizational and time management abilities  
* Excellent written and verbal communication  
* Effective advocacy and collaboration skills  
* Cultural competency and sensitivity to diverse learners  
* Ability to work independently and as part of interdisciplinary team  
* \[T3C\] Capability to coordinate educational services across multiple locations
...
* Complete required training including:  
  ...
  * \[T3C\] Service Package requirements and educational considerations  
...
* Flexibility to attend daytime school meetings and occasional evening trainings  
* \[T3C\] Available for travel between service locations as needed

---

## WORKING CONDITIONS

* Office-based with regular field travel to schools (up to 50% of time)  
* School visits during school hours required  
* Travel between Dallas and San Antonio locations for dual-location coordination  
* Computer use for documentation and reporting  
* Ability to lift educational materials (up to 15 lbs occasionally)
...
This infrastructure function may be fulfilled through duty-based assignment to qualified existing staff who possess the required education and experience. During implementation, the assigned individual develops educational coordination systems for both service locations and builds infrastructure supporting long-term sustainability.
...
* Educational stability (maintaining same school placement)  
* High school graduation rates  
* Post-secondary enrollment rates  
* Grade advancement and academic progress

**Process Measures:**

* School enrollment timeliness  
* Educational meeting attendance (ARD, IEP)  
* Educational record accuracy  
* Response time to educational concerns

**Quality Indicators:**

* Foster caregiver satisfaction with educational support  
* School collaboration effectiveness  
* \[T3C\] Contribution to CQI educational metrics
...
* \[T3C\] Cross-System Coordination function  
...
This job description fulfills the required T3C Infrastructure Function: **Education Liaison for Children in Care**

**Current Implementation:**

* **Staff Assignment:** Stephanie Bass, Case Manager with Master's degree in Education  
* **Service Coverage:** Both Dallas and San Antonio locations during implementation phase  
* **Focus:** Building educational coordination systems and processes for long-term sustainability
