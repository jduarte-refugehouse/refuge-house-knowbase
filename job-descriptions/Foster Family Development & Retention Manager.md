...
# **Foster Family Development & Retention Manager**

## **Internal Full-Time Position**

### **Position Overview**

This full-time position reports to the Program Director and/or Treatment Director and serves as the primary administrator for foster family recruitment, development, and retention. **\[T3C\]** This role fulfills the Foster Family Home Caregiver Recruitment and Retention infrastructure requirement for all Service Packages per T3C System Blueprint and ensures compliance with TAC §749 Minimum Standards for Child Placing Agencies and all RCC requirements.

### **Primary Objectives**

* Lead comprehensive foster family recruitment and retention strategies  
* **\[T3C\]** Maintain adequate foster home capacity for all Service Packages offered by the agency  
* Ensure all recruitment and retention activities comply with regulatory requirements  
* **\[TBRI\]** Implement trauma-informed recruitment and support practices throughout all processes  
* Build and maintain sustainable recruitment infrastructure  
* Achieve monthly recruitment targets with or without support staff

### **Core Responsibilities**

#### **Strategic Planning & Compliance**

* Develop and implement annual recruitment and retention strategic plan  
* **\[T3C\]** Analyze Service Package needs and align recruitment strategies accordingly  
* Ensure compliance with all TAC §749 requirements for foster home development  
* Monitor and report on recruitment metrics and outcomes  
* **\[T3C\]** Support agency's Continuous Quality Improvement initiatives  
* Maintain all required documentation for regulatory audits and reviews

#### **Direct Recruitment Activities**

**When recruitment support roles are filled:**

* Supervise and coordinate recruitment specialist activities  
* Review and approve all recruitment materials and strategies  
* Conduct monthly minimum of 2 community presentations  
* Maintain oversight of all recruitment initiatives

**When recruitment support roles are NOT filled:**

* Personally conduct minimum of 5 community presentations per month  
* Respond to all foster care inquiries within 24 hours  
* Facilitate all information meetings and orientations  
* Maintain active presence at community events  
* Manage all social media and marketing initiatives  
* Field initial inquiries and conduct screening calls

#### **Foster Family Development Process**

* Conduct or oversee all home studies and addendums  
* Obtain and verify all documentation for licensing  
* Conduct or coordinate fire and health inspections  
* Complete all reference checks for potential families  
* **\[T3C\]** Ensure homes meet requirements for intended Service Packages  
* Review and approve all home study recommendations  
* Track and resolve all licensing deficiencies  
* Maintain compliance with TAC §749.1273 through §749.1359

#### **Training Coordination & Competency Assessment**

* Schedule and coordinate all pre-service training  
* **\[T3C\]** Ensure pre-service training meets all Service Package requirements  
* **\[TBRI\]** Implement comprehensive TBRI training program for all families  
* Conduct or oversee Pre-Service training (minimum one full cycle monthly)  
* Perform assessment and certification of caregiver skills per TAC §749.869  
* Track all training completion and maintain documentation  
* Coordinate ongoing training opportunities for foster families  
* Ensure compliance with TAC §749.861 training requirements

#### **Comprehensive Records Management**

* Maintain all foster family files through licensure and beyond  
* Track criminal background checks per TAC §749.1211 through §749.1277  
* Monitor expiration dates for all licenses and certifications  
* Generate all required agency reports and licenses  
* Maintain comprehensive foster family directory:  
  * Current licensed families  
  * Families in process  
  * Potential families in pipeline  
* **\[T3C\]** Track and document Service Package credentials for each home  
* Ensure all documentation meets audit requirements

#### **Foster Family Support & Retention**

* Develop and implement comprehensive retention strategies  
* Coordinate with case managers to secure respite providers  
* Arrange alternative and substitute care as needed  
* Conduct monthly support meetings or check-ins with foster families  
* **\[T3C\]** Monitor retention rates by Service Package type  
* Analyze feedback and develop responsive strategies  
* Plan and execute quarterly appreciation events  
* Maintain 24/7 availability for foster family crises (on rotation)

#### **Data Management & Reporting**

* Maintain weekly status reports of incoming families  
* Generate monthly comprehensive reports including:  
  * Recruitment pipeline status  
  * Licensing completion rates  
  * Retention statistics by Service Package  
  * Capacity analysis  
  * Trend identification  
* **\[T3C\]** Track outcomes for Continuous Quality Improvement  
* Provide data for contract compliance reporting

#### **Community Relations & Marketing**

* Develop and maintain relationships with faith-based organizations  
* Build partnerships with community organizations  
* **\[TBRI\]** Promote trauma-informed care in all community messaging  
* Coordinate agency presence at community events  
* Develop and distribute recruitment materials  
* Maintain consistent media presence (traditional and social)
...
* Minimum 3 years experience in child welfare, foster care, or adoption  
* **\[T3C\]** Demonstrated understanding of Service Package requirements  
* Experience in program development and management  
* Proven track record in recruitment or community outreach

#### **Required Certifications**

* **\[TBRI\]** TBRI Practitioner certification required within 6 months  
* SAMA certification (or ability to obtain within 90 days)  
* PRIDE trainer certification required within 12 months  
...
* **\[T3C\]** Comprehensive knowledge of T3C Service Packages  
* Public speaking and presentation skills (bilingual preferred)  
* Database management and reporting  
* Project management expertise  
* Crisis intervention skills  
* Cultural competence and sensitivity  
* Strong written and verbal communication  
* Ability to work independently when support roles unfilled

### **Employment Requirements**

* **\[T3C\]** Must be an employee of the Child Placing Agency (not contracted)  
* Complete all required training within specified timeframes:  
  * **\[TBRI\]** Trust-Based Relational Intervention within 90 days  
  * Trauma-informed care (minimum one hour) within 30 days  
  * Human trafficking awareness (four hours) within 30 days  
  * **\[T3C\]** Agency's Evidence-informed Treatment Model within 60 days  
  * **\[T3C\]** Service Package requirements training within 30 days  
  * Minimum Standards orientation within first week  
* Pass comprehensive background checks per TAC §749.1213  
* Maintain confidentiality per TAC §749.117  
* Available for evening and weekend events  
* Participate in on-call rotation for placement emergencies

### **Physical Requirements**

* Ability to travel extensively throughout service area  
* Capable of conducting thorough home inspections  
* Ability to lift up to 25 pounds  
* Prolonged periods of sitting and computer work  
* Mental and emotional capacity to handle multiple priorities  
* Ability to respond to crisis situations

### **Working Conditions**

* Office and extensive field-based work  
* Evening and weekend events required (minimum 2 per month)  
* Travel to foster homes and community locations (up to 50% of time)  
* Fast-paced environment with monthly recruitment targets  
* Exposure to secondary trauma  
* On-call responsibilities on rotating basis

### **Performance Expectations**

#### **When Fully Staffed (with recruitment support):**

* Minimum 8 recruitment inquiries per month  
* 3-5 families achieving licensure monthly  
* 90% retention rate at 6 months  
* 100% compliance with all regulatory requirements

#### **When Operating Without Recruitment Support:**

* Minimum 5 recruitment inquiries per month  
* 2-3 families achieving licensure monthly  
* 85% retention rate at 6 months  
* 100% compliance with all regulatory requirements  
* Authority to request overtime or temporary support as needed

### **Reporting Structure**

* Reports to: Program Director and/or Treatment Director  
* Supervises: Part-time Recruitment Specialists (when filled)  
* **\[T3C\]** Collaborates with: All Service Package teams  
* Coordinates with: Case Management, Training, and Quality Assurance teams

### **Compensation Considerations**

* Position eligible for performance bonuses based on:  
  * Recruitment targets achieved  
  * Retention rates maintained  
  * **\[T3C\]** Service Package capacity goals met  
  * Quality metrics achieved  
* Additional compensation when operating without support staff

*This position is critical to maintaining T3C compliance and must be filled at all times. Temporary coverage plans must be in place for any absence exceeding 5 business days.*

**Last Updated:** \[Current Date\] **Next Review:** \[Annual Review Date\]
