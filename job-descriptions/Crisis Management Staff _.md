...
The Crisis Management Staff function provides immediate response and intervention during behavioral crises, placement disruptions, and emergency situations. This duty-based role may be fulfilled by qualified staff members who also serve other functions within the agency, ensuring 24/7 crisis response capability while maintaining operational efficiency.
...
- Assess crisis situations for safety and risk  
- Develop immediate safety plans  
- **\[T3C\]** Implement Service Package specific crisis protocols  
- Coordinate with emergency services when needed  
- Provide short-term stabilization support

**Placement Support**

- Work to prevent placement disruptions  
- **\[TBRI\]** Coach caregivers through challenging behaviors  
- Provide respite coordination during crises  
- Support emergency placement changes when necessary  
- **\[T3C\]** Follow Service Package placement stability protocols

**Collaboration and Communication**

- Coordinate with Case Managers and Therapists  
- **\[T3C\]** Communicate with Treatment Director for clinical crises  
- Update DFPS/SSCC caseworkers on critical incidents  
- Collaborate with law enforcement when required  
- Participate in crisis debriefing sessions

**Documentation and Follow-up**

- Document all crisis interventions thoroughly  
- **\[T3C\]** Complete Service Package required incident reports  
- Develop follow-up plans with treatment team  
- Track crisis patterns and trends  
...
- Minimum 2 years experience in crisis intervention or child welfare  
- **\[T3C\]** Understanding of Service Package crisis requirements

**Knowledge and Skills**

- Strong crisis intervention and de-escalation skills  
- **\[TBRI\]** Proficiency in trauma-informed approaches  
- Excellent verbal communication abilities  
- Ability to remain calm under pressure  
- **\[T3C\]** Knowledge of Service Package populations  
- Physical intervention training (CPI, Handle with Care, etc.)
...
- May be assigned to experienced Case Managers  
- Can be rotated among qualified clinical staff  
- **\[T3C\]** Must maintain required ratios for Service Packages  
- Shared on-call rotation recommended

**Coordination Requirements**

- Clear on-call schedules and coverage  
- Defined escalation procedures  
- **\[T3C\]** Integration with Service Package requirements  
- Regular crisis team meetings

## Additional Requirements

- **\[T3C\]** Can be employee or contracted (if contracted, must be trained in agency model)  
- Complete required training:  
  - **\[TBRI\]** Trust-Based Relational Intervention within 90 days  
  - **\[T3C\]** Service Package specific crisis protocols  
  - Physical intervention certification  
  - Annual crisis intervention updates  
...
- Ability to respond quickly to locations  
- Physical capability for interventions  
- Mental and emotional resilience  
- Ability to work under high stress

**Working Conditions**

- On-call rotation including nights/weekends  
- Exposure to volatile situations  
