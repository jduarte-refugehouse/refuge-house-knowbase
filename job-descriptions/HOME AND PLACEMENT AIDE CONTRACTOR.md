...
# HOME AND PLACEMENT AIDE CONTRACTOR

## Job Description

**Organization:** Refuge House, Inc.  
**Position Type:** Independent Contractor  
**Service Areas:** Dallas and San Antonio Regions  
**Reports To:** Program Director/Home Development Director  
**Compensation:**

- Home Visits: $60.00 per visit plus mileage reimbursement  
- Placements: $100.00 per visit plus mileage reimbursement

---

## POSITION SUMMARY

The Home and Placement Aide Contractor provides essential support services to foster families and children in care, ensuring compliance with Texas Child-Centered Care (T3C) standards, DFPS regulations, and Refuge House policies. This role conducts comprehensive home monitoring visits and facilitates placement activities while supporting the implementation of Trust-Based Relational Intervention® (TBRI®) principles in foster homes.

---

## ESSENTIAL FUNCTIONS

### A. HOME MONITORING AND COMPLIANCE (60%)

**1\. Conduct Monthly Foster Home Visits**

- Complete comprehensive home monitoring using Enhanced Digital Monitoring Checklist  
- Ensure compliance with RCCL Chapter 749 minimum standards  
- Verify adherence to RCC contract requirements and T3C development standards  
- Document compliance with safety, health, and environmental standards  
- Monitor implementation of trauma-informed care practices  
- **Schedule and complete visits within the first 25 days of each month to ensure Case Managers have documentation for their monthly reporting requirements**  
- **Coordinate visits by geographic area to maximize efficiency and minimize travel expenses (group homes in same area/day when possible)**  
- **Submit expense reports within 5 business days of month-end with visits properly grouped by date and location**

**2\. Documentation and Reporting**

- Complete and obtain signatures on home monitoring checklist from both contractor and family  
- Document all observations objectively using combined notes fields  
- Report any deficiencies or concerns immediately to supervisor  
- Maintain accurate records in Radius documentation system  
- Submit completed documentation within 24 hours of visit

**3\. Foster Family Support and Assessment**

- Conduct foster parent interviews to assess needs and challenges  
- Provide resources and support before citing deficiencies  
- Observe and document TBRI® practices (connecting, empowering, correcting strategies)  
- Verify completion of required training including trauma-informed care  
- Support foster families in maintaining T3C credentialing requirements

### B. CHILD WELFARE AND RIGHTS MONITORING (20%)

**1\. Child Interviews and Well-being**

- Conduct private interviews with children as age-appropriate  
- Complete ASQ suicide screening for all children age 10+ every 90 days  
- Follow immediate safety protocols for any positive screens  
- Document children's rights compliance (Form 2530 signed and posted)  
- Verify normalcy activities are supported and documented  
- Monitor sibling visits and family connections

**2\. Safety and Medical Oversight**

- Verify medication administration logs and storage  
- Review medical consent forms (Form 2759\)  
- Check Personal Safety Plans for high-risk behaviors  
- Ensure appropriate hygiene products and services availability  
- Monitor dietary needs and supervision requirements

### C. PLACEMENT SERVICES (15%)

**1\. Placement Coordination**

- Complete placement packet with all names via DocuSign  
- Coordinate pre-placement visits when possible  
- Support foster families in preparing welcoming environment  
- Facilitate emergency placement process within 24-hour timeframe

**2\. Required Documentation Collection**

- DFPS Placement Authorization (Form §749.1107a(13))  
- DFPS Medical Consent/Attachment B  
- Attachment A \- Contact Information  
- Education Decision Maker documentation  
- CPS Child Rights (Form 2530\)  
- Discipline Policy acknowledgment  
- Placement Summary

**3\. Admission Support**

- Assist with gathering Application for Placement documentation  
- Support initial health screening process  
- Help coordinate school enrollment (within 2 days)  
- Facilitate therapist identification (within 2 days for Contract 11B)  
- Support psychological/developmental assessments scheduling

### D. QUALITY ASSURANCE AND TRAINING (5%)

**1\. Continuous Improvement**

- Participate in T3C development activities  
- Provide feedback on service delivery improvements  
- Identify training needs for foster families  
- Support implementation of new procedures and policies

**2\. Professional Development**

- Maintain current knowledge of DFPS regulations  
- Stay informed on T3C Blueprint requirements  
- Complete required contractor training including Human Trafficking Prevention  
- Participate in TBRI® training updates
...
- Minimum 2 years experience in child welfare, foster care, or related field  
- Experience with residential childcare licensing standards preferred

### Required Certifications and Clearances

- Valid Texas driver's license with clean driving record  
- Current auto liability insurance  
- Clear criminal background check (FBI and state)  
- Clear Child Protective Services background check  
- Negative TB test results  
- Drug screening clearance  
- Three professional references verified

### Required Training (Must complete within 30 days)

- DFPS online training modules  
- Suicide prevention training (1 hour pre-service, biennial)  
- Human Trafficking Prevention training  
- Psychotropic medication training  
- Sexual abuse caregiver training (if applicable)  
- 16 hours SAMA training  
...
- Understanding of Texas RCCL Chapter 749 Minimum Standards  
- Knowledge of T3C Blueprint requirements and standards  
- Familiarity with TBRI® principles and trauma-informed care  
...
- Proficiency with electronic documentation systems (Radius, DocuSign)  
- Ability to conduct sensitive interviews with children and adults  
- Competent in identifying safety concerns and risk factors  
- Skilled in de-escalation and crisis intervention
...
- Maintain strict confidentiality per HIPAA requirements
...
- Capable of conducting home inspections including all areas of residence  
- Ability to sit, stand, walk for extended periods  
- Must be able to lift up to 25 pounds occasionally  
- Visual and auditory acuity to observe and assess environments

### Environmental Conditions

- Regular travel to foster homes in various neighborhoods  
- Exposure to various home environments and conditions  
- Potential exposure to communicable diseases  
- May encounter emotionally charged situations  
- Evening and weekend availability required for emergencies
...
- 100% completion of required documentation within timeframes  
- Zero critical deficiencies in documentation audits  
- Timely submission of all reports and forms  
- Maintain current certifications and training  
- **Complete 90% of monthly home visits by the 25th of each month**  
- **Submit organized expense reports within 5 business days of month-end**  
- **Achieve 80% or higher efficiency rating in geographic visit grouping**

### Quality Indicators

- Foster family satisfaction ratings  
- Child safety and well-being outcomes  
- Successful placement stability  
- Effective crisis intervention when needed

### Professional Standards

- Adherence to Refuge House Code of Ethics  
...
This is an independent contractor position, not an employment relationship. The contractor:

- Is responsible for own taxes and insurance  
- Must maintain required certifications at own expense  
- Provides own transportation and equipment  
- Works on an as-needed basis per agency requirements  
- Must complete contractor packet and clearances before starting

---

## ACKNOWLEDGMENT

By accepting this contractor position, I acknowledge that I have read and understood the job description and agree to perform all duties and responsibilities as outlined. I understand this is a contractor relationship and I am responsible for maintaining all required certifications and clearances.

**Contractor Signature:** \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ **Date:** \_\_\_\_\_\_\_\_\_\_

**Company Representative:** \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ **Date:** \_\_\_\_\_\_\_\_\_\_

---

*This job description is not intended to be all-inclusive. The contractor may be required to perform other related duties as assigned to meet the ongoing needs of the organization.*

**Equal Opportunity Statement:** Refuge House Inc. is committed to providing equal opportunities to all contractors without regard to race, color, religion, sex, national origin, age, disability, or any other protected status in accordance with applicable law.  
