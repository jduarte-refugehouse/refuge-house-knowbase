...
**T3C Blueprint Reference:** Substance Use Support Services p.59 (October 2025) - Service Plan must be informed by child/youth and include customized goals and planned services to achieve those goals.
...
**T3C Blueprint Reference:** Substance Use Support Services p.59 (October 2025) - Service Plan reviews must include documentation to show the progress made toward achieving each goal.
...
### 14.1 Drug Screening Purpose

Drug screening is a **clinical tool** to inform treatment, NOT a punitive measure. Screening supports:
- Treatment progress monitoring
- Early identification of relapse
- Service Plan adjustment
- Recovery support planning

### 14.2 Drug Screening Protocol
...
**CRITICAL:** Positive screens are addressed through treatment adjustment, NOT punishment.
