...
| **EFFECTIVE DATE** | [Date] |
| **SECTION** | FC-STASS |
| **DATE(S) OF REVISION** | January 2026 - Added Section 5.6 Service Documentation and Cost Coverage per T3C Blueprint p.70-71 requirements<br>February 2026 - Full reconciliation with October 2025 Blueprint (pages 69-77); Updated all regulatory references; Added Sections 3.3-3.8; Expanded Sections 5.7-5.10; Updated staffing infrastructure detail; Added Section 5.11 IT System Requirements<br>February 2026 (E1) - Enhancement Round 1 responses: Expanded §5.2 (Service Plan content, who informs, progress documentation); Enhanced §5.6 (CANS 3.0 results usage); Expanded §5.9 (Educational coordination with testing, plans, supports, accommodations); Enhanced §5.14 (Foster home enhanced logistical support and multi-system navigation); Expanded §4.3 (Anticipated Length of Service individualization) |
...
- **FC-STASS-01 (Quick Reference):** Lean cross-reference version for internal quick lookup
- **FC-STASS-01 (Standard):** Working template with cross-references to standalone policies

**Important Note:** Short-Term Assessment Support Services is **NOT eligible for Add-On Services** per T3C Blueprint p.69 (October 2025).
...
**T3C Blueprint Reference:** Short-Term Assessment Support Services p.69 (October 2025)
...
- **New to care**, or transitioning from an unpaid placement, and where more information is needed to understand the child's custom service need(s); **or**
- **Returning** to foster care after an unauthorized absence or unauthorized placement; **or**
- **Transitioning** based on a recent, unplanned disruption in placement; **and**
- **In need** of further assessment(s) and evaluation(s) to identify an appropriate Service Package and subsequent placement.
...
**CRITICAL:** Short-Term Assessment Support Services is NOT eligible for Add-On Services per T3C Blueprint p.69 (October 2025). The time-limited, assessment-focused nature of this package does not align with the ongoing support services provided through Add-On packages.
...
**T3C Blueprint Reference:** Short-Term Assessment Support Services p.76-77 (October 2025)
...
> | Intake/Placement Coordinator | 1. Verify child meets eligibility criteria (one of four categories)<br>2. Confirm no Add-On Services needed (not eligible)<br>3. Verify credentialed STASS home availability<br>4. Document screening outcome | Within 2 hours | T3C Blueprint p.76-77 |

### 3.3 CANS 3.0 Assessment Alignment

**T3C Blueprint Reference:** Short-Term Assessment Support Services p.76 (October 2025)
...
**Maximum 4 children** in foster care per home, unless necessary to accommodate placement of a sibling group (per T3C Blueprint p.70, October 2025).
...
> | Who | How | When |
> | :---- | :---- | :---- |
> | Intake/Placement Coordinator | 1. Receive referral from SSCC or DFPS<br>2. Determines need for assessment placement<br>3. Provides all available information<br>4. Identifies assessment priorities | Before placement |
...
- The **number and complexity of assessments** required to make an informed Service Package recommendation
- The child's **age** (which determines the 30-day or 45-day standard timeline)
- **Assessment scheduling availability** and any known barriers to timely completion
- The child's **behavioral and emotional stability** during the assessment period
- The **CANS 3.0 Assessment results** (once administered)
- The **Treatment Model** for providing Short-Term Assessment Support Services
- The **Admission Guidelines** and assessment priorities identified at intake

#### 4.3.2 What the CPA Must Include

Refuge House's anticipated Length of Service for each child must include:

- **Anticipated duration** expressed in specific days or weeks (not to exceed the established maximums of 30/45 days without extension)
- **Target assessment completion timeline** identifying milestones for each required assessment
- **Service Package recommendation target date** for when the determination is expected to be complete
- **Extension eligibility notation** if it appears assessments may require additional time beyond the standard period
...
| Who | How | When |
| :---- | :---- | :---- |
| Case Manager | 1. Document assessment progress and barriers<br>2. Request extension from Program Director<br>3. Document written justification | Before initial timeline expires |
| Program Director | 1. Review progress and barriers<br>2. Approve or deny extension<br>3. Document decision | Before initial timeline expires |
...
|--------------------|-----------|---------------------|
| Within **21 days** of admission | Children aged 5 and under | T3C Blueprint p.70 |
| Within **30 days** of admission | Children aged 6 and older | T3C Blueprint p.70 |
...
- **Customized goals** developed with meaningful input from the child/youth that reflect their strengths, needs, and assessment priorities
- **Planned services and supports** specifically identified to help achieve each goal
- **Documentation of who informed the Service Plan**, including the child/youth (when age-appropriate), Service Planning team members, Foster Family Home Caregivers, SSCC/DFPS caseworker, biological family/support persons (when safe and appropriate), educational representatives, and medical providers (as applicable)
...
- **Assessment coordination progress** specific to STASS timeline requirements
...
**T3C Blueprint Reference:** Short-Term Assessment Support Services p.70-71 (October 2025)
...
- **Inform the customized Service Plan** by identifying areas of strength and need that shape individualized assessment-focused goals
- **Guide the Service Package recommendation** for placement beyond the current Short-Term Assessment, by identifying the level of service intensity and specialization needed (e.g., Mental & Behavioral Health, IDD/Autism, Substance Use, Basic Foster Home)
- **Identify areas requiring specialized assessment** or evaluation that may not yet have been completed during the assessment window
- **Establish baseline functioning** that will serve as a comparison point for the receiving placement's future CANS 3.0 reassessments
- **Inform immediate intervention and support needs** during the remainder of the Short-Term Assessment period
...
**T3C Blueprint Reference:** Short-Term Assessment Support Services p.72-73 (October 2025)
...
- **IEP/504 Plans:** Reviewing, requesting, and advocating for Individualized Education Programs (IEP) or Section 504 plans as indicated; ensuring the receiving school has current plans and documentation
- **Supports and Accommodations:** Ensuring appropriate educational supports and accommodations are in place during the assessment period, including tutoring, supplemental services, and classroom modifications as needed
- **Education Portfolio:** Compiling educational records, testing results, IEP/504 documentation, and school performance information for inclusion in the Transition Summary and Service Package recommendation
...
- Referral source (whether SSCC or DFPS)
- Number and percentage of referrals that did and did not result in admission
- Reasons for denial of admissions based on referrals
- For children admitted: average Length of Service based on time from admission to discharge
...
- Transportation to and from all assessment appointments, evaluations, screenings, and treatment services
- Coordination with assessment providers regarding scheduling and follow-up
- Documentation and record keeping of all assessments completed, including dates, providers, and key findings
- Daily observation and documentation of the child's behavioral patterns, needs, and responses to interventions
- Communication of observations to the Service Planning team to inform assessment process
...
- **STAR Health** — managed care services, authorization requests, and care coordination
- **HHSC Behavioral Health Services** — behavioral health referrals and services as applicable
- **CANS 3.0 Assessment** — supporting assessment administration and incorporating results
- **3-day exam** — coordinating initial medical examination (if applicable)
- **Early Childhood Intervention (ECI)** — developmental services for children under 3 (if applicable)
- **Education system** — school enrollment, educational evaluations, and accommodation coordination
- **Child welfare system** — collaboration with SSCC/DFPS on assessment findings and Service Package recommendation
- **Other services as needed** — including community-based resources and specialty providers
...
- Observe and document child's behavioral patterns daily
- Note effective and ineffective intervention strategies
- Support all assessment activities including transportation to appointments
- Attend multiple team meetings during short placement
- Provide information for Transition Summary
- Support child through transition to receiving placement
...
**T3C Blueprint Reference:** Short-Term Assessment Support Services p.74-75 (October 2025)
...
- Licensed Therapist to oversee assessment coordination and service planning for children, youth, and young adults
- Education liaison for children, youth, and young adults in care
- Continuous Quality Assurance and Improvement Program
- Billing, cost reporting, and claims administration
- Cross-system coordination including but not limited to maintaining and supporting the child's school, medical, dental, behavioral health, and other service needs (must be well-versed in STAR Health services, particularly in areas of care coordination and assessment)
...
| Case Manager Supervisor | Stephanie Bass, MA, MEd, LCDC, CPMS | Supervises case management functions |
...
> |-------------------|-------|---------|--------|
> | **Initial Training** | 4 hours | - Observation and documentation techniques<br>- Supporting assessment process<br>- Unknown history considerations<br>- Managing transitions and short-term placements<br>- Crisis response for unknown history children<br>- Expedited safety planning | Before first STASS placement |
> | **Annual Refresher** | 2 hours | - Updates on best practices<br>- Case review and discussion | Annually |

### 7.3 Capacity Limitation

**Maximum 4 children in foster care** per home, unless necessary to accommodate placement of a sibling group (T3C Blueprint p.70, October 2025).

### 7.4 Foster Parent Responsibilities

Foster parents providing Short-Term Assessment services agree to:

- Observe and document child's behavioral patterns daily using the Foster Parent Daily Observation Log (Assessment Version)
- Note effective and ineffective intervention strategies
- Support all assessment activities including transportation to appointments
- Attend multiple team meetings during short placement
- Provide detailed information for Transition Summary
- Support child through transition to receiving placement

### 7.5 Home Availability

Foster Family Home must be available for admission at the time of placement match (T3C Blueprint p.77, October 2025).
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Treatment Director | 1. Review available clinical documentation<br>2. Identify assessment priorities<br>3. Confirm child appropriate for STASS<br>4. Provide clinical recommendation | Within 4 hours of screening | T3C Blueprint p.76-77 |
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Intake/Placement Coordinator | 1. Review available STASS-credentialed homes<br>2. Verify capacity (max 4 children)<br>3. Match child needs with home capabilities<br>4. Verify foster home STASS training current<br>5. Contact foster family | Within 4 hours of approval | T3C Blueprint p.77 |

### 10.4 Placement Day Activities

| Who | How | When | Regulatory Reference |
| :---- | :---- | :---- | :---- |
| Case Manager | 1. Accompany child to placement (when possible)<br>2. Conduct placement orientation<br>3. Complete initial health screening<br>4. Review emergency contacts and procedures<br>5. Begin Assessment Coordination Plan | Day of placement | TAC §749.1301 |
| Foster Parent | 1. Welcome child to home<br>2. Provide tour and orientation<br>3. Begin observation and documentation<br>4. Note initial behavioral patterns<br>5. Communicate observations to Case Manager | Day of placement; daily | Foster Parent Agreement |
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Case Manager | 1. Identify required assessments based on referral information<br>2. Submit STAR Health authorization requests<br>3. Schedule assessments within timeline (21 days age 5 and under; 30 days age 6+)<br>4. Coordinate transportation<br>5. Track assessment completion<br>6. Gather and compile results | Per timeline requirements | T3C Blueprint p.70 |
...
- Identified assessment needs based on available information
- Prioritized assessment schedule
- STAR Health authorization status for each assessment
...
- Subsequent Service Package recommendation beyond Short-Term Assessment
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Case Manager | 1. Complete CANS 3.0 assessment per timeline<br>2. Gather input from assessments and treatment team<br>3. Include immediate needs and assessment-focused goals<br>4. Document assessment coordination progress<br>5. Include Service Package recommendation process<br>6. Submit to SSCC/DFPS | Within 21 days (age 5 and under) or 30 days (age 6+) | TAC §749.1301; T3C Blueprint p.70 |
...
| Who | How | When | Regulatory Reference |
| :---- | :---- | :---- | :---- |
| Treatment Director | 1. Review all assessment results<br>2. Analyze CANS 3.0 results<br>3. Recommend appropriate Service Package<br>4. Document clinical justification | Upon assessment completion | T3C Blueprint p.71 |
| Service Planning Team | 1. Review Treatment Director recommendation<br>2. Discuss appropriateness of recommended package<br>3. Confirm or modify recommendation<br>4. Document team consensus | Within 5 business days | T3C Blueprint p.71 |
| Case Manager | 1. Document Service Package recommendation<br>2. Include recommendation in Transition Summary<br>3. Communicate to SSCC/DFPS<br>4. Coordinate transition to receiving placement | Before discharge | T3C Blueprint p.71 |
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Crisis Staff | 1. Assume potential trauma history (unknown history approach)<br>2. Use TBRI de-escalation techniques<br>3. Document ALL interventions (effective and ineffective)<br>4. Note effective and ineffective strategies for transition documentation<br>5. Include crisis patterns in transition summary | All crises | FC-04.1 Section 5 |
...
- Patterns observed over the assessment period
...
> | Who | How | When | Regulatory Reference |
> | :---- | :---- | :---- | :---- |
> | Case Manager | 1. Compile all assessment results<br>2. Prepare Service Package recommendation with clinical justification<br>3. Document comprehensive Transition Summary including:<br>   - Assessment findings<br>   - Behavioral observations from foster parents<br>   - Effective and ineffective interventions<br>   - Crisis patterns<br>   - CANS 3.0 results and interpretation<br>4. Coordinate with receiving placement<br>5. Complete handoff to receiving Case Manager | Before time limit | TAC §749.1361; T3C Blueprint p.74 |
...
- Comprehensive assessment findings from all evaluations
- CANS 3.0 Assessment results and interpretation
- Foster parent behavioral observations
- Crisis history and patterns
- Effective therapeutic strategies identified during assessment
- Recommended Service Package with clinical justification
- Suggested goals for receiving Service Plan
- Any pending assessments or evaluations
...
> | **Annual Refresher** | 2 hours | - Updates on best practices<br>- Case review and timeline compliance review | Annually |
...
- **T3C Blueprint Standards:** Pages 69-77, Short-Term Assessment Support Services (October 2025)
...
- **TAC §749.1401:** Health Care Requirements
...
- Short-Term Assessment Admission Checklist
- Assessment Coordination Plan Template
